...
import { REGISTER_USER } from '../../graphQL/auth/mutationsAuth';
...
const states = { name: false, lastName: false, numDoc: false,
  email: false, password: false, password2: false }

function UserRegisterPage() {

  const { setToken } = useAuth();
  const [formRegister, setFormRegister] = useState({});
  const [addUser, { data, error }] = useMutation(REGISTER_USER);
